...
fn highlight_color(h: Highlight, sem: &SemanticColors, default: [f32; 4]) -> [f32; 4] {
    ...
    match h {
        ...
        Highlight::CommentDoc => to_f32(&sem.syntax_comment),
        Highlight::String => to_f32(&sem.syntax_string),
        Highlight::Escape => to_f32(&sem.syntax_escape),
        Highlight::Keyword => to_f32(&sem.syntax_keyword),
        Highlight::KeywordControl => to_f32(&sem.syntax_keyword),
        Highlight::KeywordImport => to_f32(&sem.syntax_namespace),
        Highlight::Function => to_f32(&sem.syntax_function),
        Highlight::FunctionCall => to_f32(&sem.syntax_method),
        Highlight::FunctionMacro => to_f32(&sem.syntax_macro),
        Highlight::Variable => to_f32(&sem.syntax_variable),
        Highlight::Parameter => to_f32(&sem.syntax_parameter),
        Highlight::SelfKw => to_f32(&sem.syntax_builtin),
        Highlight::Type => to_f32(&sem.syntax_type),
        Highlight::TypeBuiltin => to_f32(&sem.syntax_type),
        Highlight::Constant => to_f32(&sem.syntax_constant),
        Highlight::Boolean => to_f32(&sem.syntax_constant),
        ...
        Highlight::Constructor => to_f32(&sem.syntax_type),
        Highlight::Lifetime => to_f32(&sem.syntax_lifetime),
        Highlight::Label => to_f32(&sem.syntax_lifetime),
        Highlight::Generic => to_f32(&sem.syntax_type),
        Highlight::Error => to_f32(&sem.error),
