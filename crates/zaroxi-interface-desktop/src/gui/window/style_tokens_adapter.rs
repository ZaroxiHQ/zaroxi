...
impl Default for AdapterModifiers {
    fn default() -> Self {
        Self {
            ...
            sidebar_border_dim: 0.75,
            scrollbar_track_dim_editor: 0.30,
            scrollbar_thumb_dim_editor: 0.16,
            scrollbar_track_dim_sidebar: 0.32,
            scrollbar_thumb_dim_sidebar: 0.14,
            scrollbar_track_dim_bottom: 0.34,
            scrollbar_thumb_dim_bottom: 0.18,
            breadcrumb_dim: 0.97,
            status_pill_dim: 0.14,
            status_badge_brighten: 2.2,
            status_divider_dim: 0.75,
...
pub fn resolve_style_tokens(sem: &SemanticColors, mods: &AdapterModifiers) -> StyleTokens {
    ...
    let sidebar_file_item = sidebar_bg.adjust_brightness(0.90);
