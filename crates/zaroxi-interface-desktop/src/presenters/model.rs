...
// TabEntry and TabStrip moved to application-editor view models to own tab metadata.
// The presenter consumes the authoritative types via a re-export from the application crate.

pub use zaroxi_application_editor::view_model::{TabEntry, TabStrip};
