...
async fn confirm_close_active_prefers_neighbor_and_updates_state() {
    ...
    impl ports::WorkspaceService for TwoBufService {
        fn boot_workspace(&self, _req: ports::WorkspaceBootRequest) -> ports::BoxFuture<'static, Result<ports::WorkspaceBootResponse, ports::UseCaseError>> {
            Box::pin(async { Err(ports::UseCaseError::UnknownWorkspace) })
        }
        fn open_buffer(&self, _req: ports::OpenBufferRequest) -> ports::BoxFuture<'static, Result<ports::OpenBufferResponse, ports::UseCaseError>> {
        ...
        fn list_open_buffers(&self, _req: ports::ListBuffersRequest) -> ports::BoxFuture<'static, Result<ports::ListBuffersResponse, ports::UseCaseError>> {
            ...
            Box::pin(async move {
                Ok(ports::ListBuffersResponse { buffer_ids: vec![buf1.clone(), buf2.clone()], active_buffer: Some(buf1.clone()) })
            })
        }
        fn set_active_buffer(&self, _req: ports::SetActiveBufferRequest) -> ports::BoxFuture<'static, Result<ports::SetActiveBufferResponse, ports::UseCaseError>> {
            Box::pin(async { Err(ports::UseCaseError::UnknownSession) })
        }
        ...
        fn apply_text_transaction(&self, _req: ports::ApplyTextTransactionRequest) -> ports::BoxFuture<'static, Result<ports::ApplyTextTransactionResponse, ports::UseCaseError>> { Box::pin(async { Ok(ports::ApplyTextTransactionResponse { ok: true, state: ports::EditorState { cursor: ports::EditorCursor::zero(), selection: None }, content: None }) }) }
        ...
        fn get_session_snapshot(&self, _req: ports::GetSessionSnapshotRequest) -> ports::BoxFuture<'static, Result<ports::GetSessionSnapshotResponse, ports::UseCaseError>> { Box::pin(async { Err(ports::UseCaseError::UnknownSession) }) }
        ...
        fn save_checkpoint(&self, _req: ports::SaveCheckpointRequest) -> ports::BoxFuture<'static, Result<ports::SaveCheckpointResponse, ports::UseCaseError>> { Box::pin(async { Err(ports::UseCaseError::UnknownSession) }) }
...
async fn closing_last_buffer_leaves_coherent_empty_state() {
    ...
    impl ports::WorkspaceService for OneBufService {
        ...
        fn get_active_buffer(&self, _req: ports::GetActiveBufferRequest) -> ports::BoxFuture<'static, Result<ports::GetActiveBufferResponse, ports::UseCaseError>> { Box::pin(async { Err(ports::UseCaseError::UnknownSession) }) }
        fn set_editor_cursor(&self, _req: ports::SetEditorCursorRequest) -> ports::BoxFuture<'static, Result<ports::SetEditorCursorResponse, ports::UseCaseError>> { Box::pin(async { Err(ports::UseCaseError::UnknownSession) }) }
        fn set_editor_selection(&self, _req: ports::SetSelectionRequest) -> ports::BoxFuture<'static, Result<ports::SetSelectionResponse, ports::UseCaseError>> { Box::pin(async { Err(ports::UseCaseError::UnknownSession) }) }
        fn clear_editor_selection(&self, _req: ports::ClearSelectionRequest) -> ports::BoxFuture<'static, Result<ports::ClearSelectionResponse, ports::UseCaseError>> { Box::pin(async { Err(ports::UseCaseError::UnknownSession) }) }
        fn get_editor_state(&self, _req: ports::GetEditorStateRequest) -> ports::BoxFuture<'static, Result<ports::GetEditorStateResponse, ports::UseCaseError>> { Box::pin(async { Err(ports::UseCaseError::UnknownSession) }) }
...
async fn confirm_cancel_close_clears_pending_without_closing() {
    ...
    impl ports::WorkspaceService for TwoBufSvcForCancel {
        ...
        fn list_open_buffers(&self, _req: ports::ListBuffersRequest) -> ports::BoxFuture<'static, Result<ports::ListBuffersResponse, ports::UseCaseError>> {
            ...
            Box::pin(async move { Ok(ports::ListBuffersResponse { buffer_ids: vec![buf1.clone(), buf2.clone()], active_buffer: Some(buf1.clone()) }) })
        }
        fn set_active_buffer(&self, _req: ports::SetActiveBufferRequest) -> ports::BoxFuture<'static, Result<ports::SetActiveBufferResponse, ports::UseCaseError>> { Box::pin(async { Err(ports::UseCaseError::UnknownSession) }) }
        fn get_active_buffer(&self, _req: ports::GetActiveBufferRequest) -> ports::BoxFuture<'static, Result<ports::GetActiveBufferResponse, ports::UseCaseError>> { Box::pin(async { Err(ports::UseCaseError::UnknownSession) }) }
        fn set_editor_cursor(&self, _req: ports::SetEditorCursorRequest) -> ports::BoxFuture<'static, Result<ports::SetEditorCursorResponse, ports::UseCaseError>> { Box::pin(async { Err(ports::UseCaseError::UnknownSession) }) }
    ...
    let svc = std::sync::Arc::new(TwoBufSvcForCancel) as std::sync::Arc<dyn ports::WorkspaceService>;
    // refresh to populate composition metadata via the fake service
    let _ = refresh_desktop(&mut comp, view.clone(), sid.clone(), None, Some(svc.clone()))
        .await
        .expect("refresh ok");
