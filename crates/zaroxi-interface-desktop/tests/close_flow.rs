...
use zaroxi_application_workspace::ports::{
    ...
    GetVisibleLinesRequest, GetVisibleLinesResponse, SessionId, UseCaseError, WorkspaceService,
    WorkspaceView,
};
...
async fn request_close_session_enters_pending_close_when_dirty() {
    ...
    impl WorkspaceService for DirtyService {
        ...
        ) -> BoxFuture<'static, Result<ports::WorkspaceBootResponse, UseCaseError>> {
            Box::pin(async { Err(UseCaseError::UnknownWorkspace) })
        }
        fn open_buffer(
            &self,
            _req: ports::OpenBufferRequest,
        ) -> BoxFuture<'static, Result<ports::OpenBufferResponse, UseCaseError>> {
            Box::pin(async { Err(UseCaseError::UnknownSession) })
        }
        fn list_open_buffers(
            &self,
            _req: ports::ListBuffersRequest,
        ) -> BoxFuture<'static, Result<ports::ListBuffersResponse, UseCaseError>> {
        ...
        ) -> BoxFuture<'static, Result<ports::GetEditorStateResponse, UseCaseError>> {
            Box::pin(async { Err(UseCaseError::UnknownSession) })
        }
        ...
        ) -> BoxFuture<'static, Result<ports::UpdateBufferResponse, UseCaseError>> {
            Box::pin(async { Err(UseCaseError::UnknownSession) })
        }
        fn apply_text_transaction(
            &self,
            _req: ports::ApplyTextTransactionRequest,
        ) -> BoxFuture<'static, Result<ports::ApplyTextTransactionResponse, UseCaseError>> {
            Box::pin(async {
...
impl WorkspaceView for FakeView {
    ...
    fn get_active_editor_document(
        &self,
        _req: GetActiveEditorDocumentRequest,
    ) -> BoxFuture<'static, Result<ports::GetActiveEditorDocumentResponse, ports::UseCaseError>>
    {
        let doc = ports::EditorDocument {
            buffer_id: self.buffer_id.clone(),
            content: Some("line1".to_string()),
    ...
    fn get_visible_lines(
        &self,
        _req: GetVisibleLinesRequest,
    ) -> BoxFuture<'static, Result<ports::GetVisibleLinesResponse, ports::UseCaseError>> {
        let vl = VisibleLine {
            line_number: 1,
            text: "line1".to_string(),
            is_cursor_line: true,
...
async fn request_close_session_enters_pending_close_when_dirty() {
    ...
    impl ports::WorkspaceService for Svc {
        ...
        {
            Box::pin(async { Ok(ports::SaveCheckpointResponse { location: "loc".to_string() }) })
        }
        fn load_checkpoint(
            &self,
            _req: ports::LoadCheckpointRequest,
...
impl crate::ports::WorkspaceService for CleanSvc {
    ...
    > {
        Box::pin(async {
            Ok(crate::ports::ListBuffersResponse { buffer_ids: vec![], active_buffer: None })
        })
    }
    fn set_active_buffer(
        &self,
    ...
    fn set_editor_cursor(
        &self,
        _req: crate::ports::SetEditorCursorRequest,
    ) -> crate::BoxFuture<
        'static,
    ...
    > {
        Box::pin(async { Ok(crate::ports::SaveCheckpointResponse { location: "loc".to_string() }) })
    }
    fn load_checkpoint(
        &self,
...
impl WorkspaceView for FakeView {
    fn get_buffer_content(
        &self,
        _buffer_id: BufferId,
    ) -> ports::BoxFuture<'static, Result<Option<String>, ports::UseCaseError>> {
        Box::pin(async move { Ok(Some("".to_string())) })
    }
    ...
    fn get_active_editor_document(
        ...
        'static,
        Result<ports::GetActiveEditorDocumentResponse, ports::UseCaseError>,
    > {
        let doc = ports::EditorDocument {
            buffer_id: self.buffer_id.clone(),
            content: Some("line1".to_string()),
    ...
    fn get_visible_lines(
        &self,
        _req: GetVisibleLinesRequest,
    ) -> ports::BoxFuture<'static, Result<ports::GetVisibleLinesResponse, ports::UseCaseError>>
    {
        let vl = VisibleLine {
            line_number: 1,
            text: "line1".to_string(),
