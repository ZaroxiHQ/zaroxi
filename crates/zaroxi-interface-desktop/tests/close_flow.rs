...
async fn request_close_session_enters_pending_close_when_dirty() {
    ...
    impl crate::ports::WorkspaceService for Svc {
        ...
        fn list_open_buffers(&self, _req: crate::ports::ListBuffersRequest) -> crate::BoxFuture<'static, Result<crate::ports::ListBuffersResponse, crate::ports::UseCaseError>> { Box::pin(async { Ok(crate::ports::ListBuffersResponse { buffer_ids: vec![self.buf.clone()], active_buffer: Some(self.buf.clone()) }) }) }
        ...
        fn get_active_buffer(&self, _req: crate::ports::GetActiveBufferRequest) -> crate::BoxFuture<'static, Result<crate::ports::GetActiveBufferResponse, crate::ports::UseCaseError>> { let b = self.buf.clone(); Box::pin(async move { Ok(crate::ports::GetActiveBufferResponse { buffer_id: b }) }) }
