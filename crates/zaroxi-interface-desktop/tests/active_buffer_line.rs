...
fn absent_before_first_refresh() {
    ...
    let got = ActiveBufferLine::from_parts(0, Some("buf-123".to_string()), Some("main.rs".to_string()));
...
fn present_after_first_refresh() {
    ...
    let got = ActiveBufferLine::from_parts(1, Some("buf-123".to_string()), Some("main.rs".to_string()));
