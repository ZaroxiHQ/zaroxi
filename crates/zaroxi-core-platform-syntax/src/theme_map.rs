...
impl SemanticTokenType {
    ...
    pub fn from_highlight(highlight: Highlight) -> Self {
        match highlight {
            ...
            Highlight::CommentDoc => SemanticTokenType::Comment,
            Highlight::String => SemanticTokenType::String,
            Highlight::Escape => SemanticTokenType::Escape,
            Highlight::Keyword => SemanticTokenType::Keyword,
            Highlight::KeywordControl => SemanticTokenType::Keyword,
            Highlight::KeywordImport => SemanticTokenType::Namespace,
            Highlight::Function => SemanticTokenType::Function,
            Highlight::FunctionCall => SemanticTokenType::Function,
            Highlight::FunctionMacro => SemanticTokenType::Macro,
            Highlight::Variable => SemanticTokenType::Variable,
            Highlight::Parameter => SemanticTokenType::Parameter,
            Highlight::SelfKw => SemanticTokenType::Builtin,
            Highlight::Type => SemanticTokenType::Type,
            Highlight::TypeBuiltin => SemanticTokenType::Type,
            Highlight::Constant => SemanticTokenType::Constant,
            Highlight::Boolean => SemanticTokenType::Constant,
            ...
            Highlight::Constructor => SemanticTokenType::Type,
            Highlight::Lifetime => SemanticTokenType::Type,
            Highlight::Label => SemanticTokenType::Type,
            Highlight::Generic => SemanticTokenType::Type,
            Highlight::Error => SemanticTokenType::Plain,
